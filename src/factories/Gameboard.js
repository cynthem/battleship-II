...
export default class Gameboard {
    ...
    placeShips(ship) {
        ...
        if (ship === this.battleship) {
            const startChoices = [8, 9, 18, 19, 28, 29, 38, 39, 48, 49, 58, 59, 68, 69];
            const startPlace = startChoices[Math.floor(Math.random() * startChoices.length)];
        ...
        if (ship === this.cruiser) {
            const startChoices = [42, 43, 44, 52, 53, 54, 62, 63, 64];
            const startPlace = startChoices[Math.floor(Math.random() * startChoices.length)];
        ...
        if (ship === this.submarine) {
            const startChoices = [0, 10, 20, 30, 40, 50, 60, 70];
            const startPlace = startChoices[Math.floor(Math.random() * startChoices.length)];
        ...
        if (ship === this.destroyer) {
            const startChoices = [82, 83, 84, 85, 92, 93, 94, 95];
            const startPlace = startChoices[Math.floor(Math.random() * startChoices.length)];
